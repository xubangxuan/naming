        ...
        <div class="allContents">
            <div style="width:80%;margin:0 auto">
                <div style="padding:45px 10%">
                    <p>
                        <span class="names">{{obj.username}}</span>
                    </p>
                    <p>
                    ...
                    <div class="personDetail">
                        ...
                        <p>传承名称：</p>
                        <p>传承简介：</p> -->
                        <p>传承者简介：<span style="display:inline" v-html="obj.user_intro"></span></p>
                    </div>
                </div>
            </div>
            <div style="background-color:#f5f5f5">
                <div style="width:80%;margin:0 auto">
                    ...
                    <div class="contents" style="padding:70px 0">
                        <div @click="dianzan(obj.like)" class="contentss" :class="obj.like?'onlyAnniu':'anniu'">
