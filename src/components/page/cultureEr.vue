        ...
        <div class="allContent">
            <div style="width:80%;margin:0 auto;">
                ...
                <div class="styleChoose">
                    <span @click="spanClick(index,item.style)" class="allStyles" :class="onIndex==index?'onAllStyles':''" v-for="(item,index) in styleList" :key="index">
                        {{item.name}}
                    </span>
                </div>
                <!-- 列表 -->
                    ...
                    <div v-for="(item,index) in list" :key="index" >
                        <div @click="goDetail(item.id)" class="contentss">
                            ...
                            <div style="width:370px;margin-top:26px">
                                <p class="names projece">{{item.username}}</p>
